        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createPriceItem("Total MRP", formatMoney(5197), Colors.grey.shade700),
              createPriceItem("Bag discount", formatMoney(3280), Colors.teal.shade300),
              createPriceItem("Tax", formatMoney(96), Colors.grey.shade700),
              createPriceItem("Order Total", formatMoney(2013), Colors.grey.shade700),
